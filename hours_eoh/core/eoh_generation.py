...
def ecological_eoh(
    ...
    0.017–0.096 h/ha·yr — the stock is 0.56% of the flow. A small ecological
    domain is the partition working, not the partition failing.
    ...
    **Physical state input**: monitoring_capability is the explicit physical
    ...
    return ecological_eoh_breakdown(
        ...
        restoration_obligation, health_response,
    )["total"]
...
def ecological_eoh_breakdown(
    ...
    **Physical state input**: monitoring_capability is the explicit physical
    ...
    if health_response == "guf":
        total = (standing + visible_deferred
