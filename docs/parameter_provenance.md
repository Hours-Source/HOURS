...
### Current (post-K-IV, re-anchored to the ε_ref fixed point seven times)

Canonical-arc figures, re-measured 2026-09-01 (after the Phase 2 adoption) from
`python3 utils/eoh_cli.py --no-color arc --domain-shares --points 100`:

| Domain | ε = 0 | ε = 0.40 | ε = 0.99 |
|---|---|---|---|
| personal | 99.2% | 87.1% | **52.1%** |
| infrastructure | 0.0% | 5.3% | 8.6% |
| knowledge | 0.8% | 7.6% | 39.3% |
